...
PLANNER_MAX_PLAN_ITEMS = 7
PLANNER_DECAYING_BOOST = 10.0
PLANNER_DECAYING_OVERDUE_MAX = 5.0
PLANNER_PATH_RELEVANCE_MAX = 5.0
PLANNER_QUICK_WIN_BONUS = 2.0
PLANNER_DIFFICULTY_WEIGHT = 1.0
PLANNER_BLOOM_WEIGHT = 0.5
PLANNER_USER_PRIORITY_MULTIPLIER = 8.0
PLANNER_SOFT_PREREQ_BONUS = 1.0
